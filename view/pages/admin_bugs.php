...
<body class="container">
    ...
    <div class="main">
      <img src="../assets/enviados.png" aria-hidden="true" alt="app_logo" class="app__logo"/>
      <strong style="color: #225300; font-family: 'Montserrat-Bold';font-size: 25px; margin-bottom:28rem;margin-top:1rem;">Enviados</strong>
      <img src="../assets/naolidos.png" aria-hidden="true" alt="app_logo" class="app__naolido"/>
