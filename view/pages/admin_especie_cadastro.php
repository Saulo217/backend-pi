  ...
  <body class="container">
    ...
    <div class="main">
      <label for="foto_planta" class="section__info">
        <img src="../assets/lotus.png" aria-hidden="true" alt="app_logo" class="app__logo" />
      ...
      <form class="form">
        ...
        <input placeholder="Idade Minima Florescimento" type="number" id="idade_minima_florescimento" />
        <input placeholder="Quantidade De Agua(Irrigação)" type="text" id="quantidade_agua_irrigacao" />
        ...
        <input type="button" onclick="cadastro()" value="Concluir" id="button">
      </form>
    </div>
